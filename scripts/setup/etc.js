...
let i2 = new ethers.utils.Interface(ABIS.OFFCHAIN_AGG);
...
let d2 = "";


// interface.parseTransaction({data: data});
// interface.decodeFunctionData("acceptOwnership", data);

let decoded = i2.parseTransaction({data: d2});
let result = decoded.args[0];
// console.log(result);
let decoder = new ethers.utils.AbiCoder();
let res = decoder.decode(['bytes32', 'bytes32', 'int192[]'], result);
console.log(res);
let prices = res[2];
let price = prices[0];
