...
exports.ADDRS = {
  ...
  // TODO: add users to this list, delete them fom the db, and never fetch them again
  // TODO analyze what is wrong with them and why some give crazy large numbers
  // TODO more eth to pay base fee, but fix high numbers first 
  // liquidate seize too much in reverrt message 
  BLACKLISTED_USERS: [
    // TODO not enuff reserves for this guy
    "0x53311150764f7eb2999022ed1aa5a8c17bb5fc57",
    // already liquidated?
    "0xb07421eecdb730794b3a7e76e54e7683c3687d8b",
    "0x15200b08325069ea4edd0cec4baf75853b200b5c",
    "0x272d6affacbb4edaa6256ac33df339318bd11af9"
  ],
...
exports.PARAMS = {
  ...
  GAS_PRICE_FRACTION_TO_PAY_MINER: 0.60,
  MIN_LIQ_PROFIT: 200,
  MIN_LIQ_PROFIT_IN_ETH: "0.08",
  ...
  // DB
  COMPOUND_USER_MAX_HEALTH: 1.15,
  COMPOUND_USER_MIN_HEALTH: 0.93,
