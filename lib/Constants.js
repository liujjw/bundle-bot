...
exports.PARAMS = {
    ...
    /* Scenario: 20k collateral * 1.1 = 2k profit -> 90% go to miner -> 2k - 1.8k -> leaves 200$ profit. MIN_LIQ_PROFIT = Collateral_size * Liq_incentive * Fraction_left_after_mev */
    MIN_LIQ_PROFIT: 200,
    ...
    v2_WINNING_GAS_PRICE_FRACTION_TO_PAY_MINER: 0.90,
    NUM_THREADS: Math.floor(cpus().length / 2) 
}