...
exports.ENDPOINTS = {
    ETH_GAS_STATION_ETH_GAS: 
        `https://data-api.defipulse.com/api/v1/egs/api/ethgasAPI.json?api-key=${process.env.ETHGASSTATION_KEY}`,
    ETH_GAS_STATION_PREDICTION_TABLE: 
        `https://data-api.defipulse.com/api/v1/egs/api/predictTable.json?api-key=${process.env.ETHGASSTATION_KEY}`,
    THE_GRAPH: 
...
exports.TX_CONST = {
    ...
    // with most of profits going to miners, will need this to be low, but not so low that math/price imprecision could give negative profit
    // 20k * 1.1 = 2k profit -> 95% go to miner -> 2k - 1.9k -> leaves 100$ profit
    MIN_LIQ_PROFIT: 100
}
...
exports.LOCAL = {
    RUNNER_PORT:
        5000,
    RUNNER_WEBHOOKS_PATH: 
        '/blocknative-webhook',
    REDIS_ACCOUNTS_STORE_HOST: 
        'localhost',
    REDIS_TEST_ACCOUNTS_STORE_HOST:
        'localhost',
    // default redis port
    REDIS_PORT:
        6379,
