...
class AuctionBidPricer {
  ...
  async v1_getWinningGasPrice(
    ...
    for (const block of blocks) {
      ...
      if (upperBoundProfit - gasFeeInDollars > PARAMS.MIN_LIQ_PROFIT_LESS_MEV_LESS_MEV_LESS_MEV_LESS_MEV_LESS_MEV_LESS_MEV) {
  ...
  async getTip(gasUsedUpperBound, upperBoundProfit, baseFee) {
    ...
    const mevRatio = PARAMS.PROFIT_FRACTION_TO_PAY_MINER;
