...
class FindShortfallPositions {
    constructor(
        ...
        // TODO parse params into a useable format such as native BigInt immediately after being fetched as string from the db
    ...
    async getLiquidationTx(user) {
        ...
        // TODO does not account for interest accumulation
        ...
        let gasUpperBoundLimit = BigNumber.from(PARAMS.LIQUIDATION_GAS_UPPER_BOUND);
        ...
        // TODO simulate what price(s) it would take to liquidate and log them
