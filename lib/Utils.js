...
exports.numDecimals = function(symbol) {
    switch(symbol) {
        case "WETH": case "DAI": case "BAT": case "UNI": case "ZRX": 
        case "COMP": case "LINK": case "ETH": case "TUSD":
            return 18;
        case "USDC": case "USDT": 
            return 6;
        case "WBTC":
...
// FEATURE deprecate this in favor of something more accurate
...
exports.parseUnitsHelper = function parseUnitsHelper(amount, symbol) {
    // FEATURE use BigDecimal
    switch (symbol) {
        case "ETH": case "DAI": case "BAT": case "UNI": case "ZRX": case "TUSD": 
        case "LINK": case "COMP": case "WETH": 
...
// FEATURE refactor with reverse obj, split up addrs into caddrs, erc20 addrs, etc
exports.cTokenSymbolOfAddress = function(address) {
    switch(address){
        case ADDRS.cETH:  return 'cETH';  case ADDRS.cDAI:  return 'cDAI';
        case ADDRS.cWBTC: return 'cWBTC'; case ADDRS.cBAT:  return 'cBAT'
        case ADDRS.cUNI:  return 'cUNI';  case ADDRS.cUSDC: return 'cUSDC';
        case ADDRS.cUSDT: return 'cUSDT'; case ADDRS.cZRX:  return 'cZRX';
        case ADDRS.cCOMP: return 'cCOMP'; case ADDRS.cREP:  return 'cREP';
        case ADDRS.cSAI:  return 'cSAI';  case ADDRS.cLINK: return 'cLINK';
        case ADDRS.cTUSD: return 'cTUSD';
        default: 
