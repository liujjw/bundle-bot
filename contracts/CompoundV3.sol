...
contract CompoundV3 is IFlashLoanReceiver {
    ...
    // UPDATE add safety checks on erc20 approves, switch over Erc20Interface to IERC20 to use SafeERC20
    ...
    function executeOperation(
        ...
        bool isEthBorrow = TOKEN_BORROWED == ADDRESSES["WETH"];
